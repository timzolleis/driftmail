        ...
        <form @submit.prevent="postForm">
            <main class="space-y-2">
                <section class="space-y-2">
                    <p
                        class="font-inter text-gray-800 font-medium text-title-small"
                    >
                        General
                    </p>
                    <CardContainer>
            ...
            <section class="w-full flex justify-end mt-3">
                <div class="flex gap-2 items-center">
                    <button
                        type="submit"
                        class="px-5 py-2 rounded bg-black font-inter text-white"
                    >
                        Save
                    </button>
                    <button
                        type="button"
                        @click="router.get('/')"
                        class="px-5 py-2 rounded ring ring-1 ring-black font-inter"
                    >
                        Cancel
                    </button>
                </div>
