        ...
        <div class="grid grid-cols-2 gap-2">
            <section class="font-inter">
                <CardContainer class="space-y-2">
                    ...
                    <p class="text-gray-600 text-xs">
                        Permanently delete your project and all associated
                        templates, variables and settings. This action cannot be
                        undone!
                    </p>
                    <BlackButton
            ...
            <section class="font-inter">
                <CardContainer class="space-y-2">
                    ...
                    <p class="text-gray-600 text-xs">
                        Export your project settings to a .json file. Please
                        keep in mind that this file is not encoded! Exclude any
                        sensitive data.
                    </p>
                    <BlackButton
                        @click="exportProject"
